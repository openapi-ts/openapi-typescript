...
describe("client", () => {
  ...
  describe("queryOptions", () => {
    ...
    it.skip("returns query options that can be passed to useQueries", async () => {
    ...
    it.skip("returns query options that can be passed to useQuery", async () => {
    ...
    it.skip("returns query options that can be passed to useSuspenseQuery", async () => {
    ...
    it.skip("returns query options without an init", async () => {
      //   const fetchClient = createFetchClient<minimalGetPaths>({
      //     baseUrl,
      //     fetch: () => Promise.resolve(Response.json(true)),
      //   });
  ...
  describe("useQuery", () => {
    ...
    it.skip("should infer correct data and error type", async () => {
      // const fetchClient = createFetchClient<paths>({
      //   baseUrl,
      //   fetch: fetchInfinite,
      // });
    ...
    it.skip("should infer correct data when used with select property", async () => {
    ...
    it.skip("uses provided options", async () => {
  ...
  describe("useSuspenseQuery", () => {
    it.skip("should resolve data properly and have error as null when successfull request", async () => {
      // const fetchClient = createFetchClient<paths>({ baseUrl });
      // const client = createClient(fetchClient);
      //
      // useMockRequestHandler({
    ...
    it.skip("should properly propagate error to suspense with a failed http request", async () => {
      // const fetchClient = createFetchClient<paths>({ baseUrl });
      // const client = createClient(fetchClient);
    ...
    it.skip("passes abort signal to fetch", async () => {
      //   let signalPassedToFetch: AbortSignal | undefined;
      //
      //   const fetchClient = createFetchClient<paths>({
      //     baseUrl,
  ...
  describe("useMutation", () => {
    describe("mutate", () => {
      ...
      it.skip("should resolve error properly and have undefined data when failed request", async () => {
        // const fetchClient = createFetchClient<paths>({ baseUrl });
        // const client = createClient(fetchClient);
        //
        // useMockRequestHandler({
      ...
      it.skip("should resolve data properly and have error as null when mutationFn returns null", async () => {
        // const fetchClient = createFetchClient<paths>({ baseUrl });
        // const client = createClient(fetchClient);
        //
        // useMockRequestHandler({
      ...
      it.skip("should resolve data properly and have error as null when mutationFn returns undefined", async () => {
        // const fetchClient = createFetchClient<paths>({ baseUrl });
        // const client = createClient(fetchClient);
        //
        // useMockRequestHandler({
    ...
    describe("mutateAsync", () => {
      it.skip("should resolve data properly", async () => {
        // const fetchClient = createFetchClient<paths>({ baseUrl });
        // const client = createClient(fetchClient);
        //
        // useMockRequestHandler({
      ...
      it.skip("should throw an error when failed request", async () => {
        // const fetchClient = createFetchClient<paths>({ baseUrl });
        // const client = createClient(fetchClient);
        //
        // useMockRequestHandler({
  ...
  describe("useInfiniteQuery", () => {
    it.skip("should fetch data correctly with pagination and include cursor", async () => {
      // const fetchClient = createFetchClient<paths>({ baseUrl });
      // const client = createClient(fetchClient);
      //
    ...
    it.skip("should reverse pages and pageParams when using the select option", async () => {
      // const fetchClient = createFetchClient<paths>({ baseUrl });
      // const client = createClient(fetchClient);
      //
      // // First page request handler
    ...
    it.skip("should use custom cursor params", async () => {
      // const fetchClient = createFetchClient<paths>({ baseUrl });
      // const client = createClient(fetchClient);
      //
      // // First page request handler
