...
export interface Pet extends _Pet { };
export interface Pets extends _Pets { };
export interface Model extends _Model { };
export interface person extends _person { };

type _Pet = components["schemas"]["Pet"];
type _Pets = components["schemas"]["Pets"];
type _Model = components["schemas"]["Model"];
type _person = components["schemas"]["person"]
